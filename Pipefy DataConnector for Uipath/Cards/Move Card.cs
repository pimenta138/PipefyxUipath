...
{
    public class Move_Card : CodeActivity
    {
        [Category("Input")]
        ...
        [Category("Input")]
        [Description("Card ID that will be moved")]
        [RequiredArgument]
        ...
        [RequiredArgument]
        public InArgument<string> PhaseID { get; set; }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            req.Method = "POST";
            byte[] bytes = System.Text.Encoding.UTF8.GetBytes("{\"query\": \"mutation{ moveCardToPhase(input: {card_id: " + CardID.Get(context) + " destination_phase_id: " + PhaseID.Get(context) + " }){ card{ id current_phase { name } } } }\" }");
