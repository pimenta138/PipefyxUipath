...
namespace Pipefy.Database
{
    public class List_Tables : CodeActivity
    {
        [Category("Input")]
        ...
        [RequiredArgument]
        public InArgument<Array> TablesID { get; set; }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            req.Method = "POST";
            byte[] bytes = System.Text.Encoding.UTF8.GetBytes("{ \"query\": \"{ tables(ids: [\"" + TablesID.Get(context) + "\"]) { id name url } }\"}");
