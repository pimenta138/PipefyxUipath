...
namespace Pipefy.Phases
{
    public class List_Cards : CodeActivity
    {
        [Category("Input")]
        ...
        [Category("Input")]
        [Description("Phase ID that will list the cards")]
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            req.Method = "POST";
            byte[] bytes = System.Text.Encoding.UTF8.GetBytes("{ \"query\": \"{ phase(id: " + PhaseID.Get(context) + ") { id name cards_count cards { edges { node { id title } } } fields { id } } }\" }");
