...
{
    public class Delete_Pipe : CodeActivity
    {
        [Category("Input")]
        ...
        [Category("Input")]
        [Description("Pipe ID that will be deleted")]
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            req.Method = "POST";
            byte[] bytes = System.Text.Encoding.UTF8.GetBytes("{ \"query\": \"mutation { deletePipe(input: { id: " + PipeID.Get(context) + "  }) { success } }\" }");
